...
public class MovieServletController extends HttpServlet {
  ...
  ObjectMapper mapper = new ObjectMapper();//transforma lista peliculas java a lista peliculas json
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    ...
    logger.info("route : " + route);
    logger.info("req : " + req);
    logger.info("req : " + req.getParameter("titulo"));
    switch(route) {
      case "add"-> {
        ...
        logger.info(titulo, descripcion,genero,calificacion,anio,estrellas,director);

        Pelicula newMovie = new Pelicula(titulo, descripcion, genero, calificacion, anio, estrellas, director);
